...
function Login(){
    return(
        <div className="flex flex-col h-screen w-screen bg-background font-text sm:flex-row">
            {/* Login  Container*/}
            <div className="container bg-Third h-1/2 sm:h-screen">
                <div className="container h-screen flex justify-center items-center flex-col">
                    ...
                    <button className="btn bg-secondary text-white w-5/8">Login</button>
                    <button className="btn bg-primary text-white w-5/8">Sign Up</button>
                </div>
            </div>
